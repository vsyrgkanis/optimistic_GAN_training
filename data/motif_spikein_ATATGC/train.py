...
from oftl import SGD_v1, RMSprop_v1
...
if __name__ == '__main__':
    ...
    optimizer_lr = 5e-04
    d_optim = RMSprop_v1(lr=optimizer_lr)
    g_optim = RMSprop_v1(lr=optimizer_lr)
    ...
    for epoch in range(epochs):
        ...
        generated_images = generator.predict(noise, verbose=0)
        pickle.dump(generated_images, join(outdir, 'plot_epoch_{0:03d}_generated.pkl'.format(epoch)))
